  ...
  return (
    <FooterStyle>
      ...
      <div>
        CVR: 12345678
        <br />
        MAIL: info@wallywood.dk
        <br />
        MOBIL: +45 9812 3456
      </div>
      <div>
        <svg
          id="SoMe_Icon_Pinterest"
          data-name="SoMe_Icon_Pinterest"
        ...
        >
          <path
            ...
            d="M25,2.25H3a3,3,0,0,0-3,3v22a3,3,0,0,0,3,3H25a3,3,0,0,0,3-3v-22A3,3,0,0,0,25,2.25Zm-3.056,9.925c.012.175.012.356.012.531A11.583,11.583,0,0,1,10.294,24.369,11.609,11.609,0,0,1,4,22.531a8.636,8.636,0,0,0,.988.05,8.218,8.218,0,0,0,5.088-1.75,4.1,4.1,0,0,1-3.831-2.844,4.418,4.418,0,0,0,1.85-.075,4.1,4.1,0,0,1-3.281-4.025v-.05a4.1,4.1,0,0,0,1.85.519,4.09,4.09,0,0,1-1.825-3.413,4.048,4.048,0,0,1,.556-2.069,11.639,11.639,0,0,0,8.45,4.288,4.108,4.108,0,0,1,6.994-3.744,8.032,8.032,0,0,0,2.6-.988,4.088,4.088,0,0,1-1.8,2.256A8.157,8.157,0,0,0,24,10.05,8.628,8.628,0,0,1,21.944,12.175Z"
            transform="translate(0 -2.25)"
            fill="#ccc"
          />
        </svg>
